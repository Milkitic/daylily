...
namespace Daylily.Plugin.Kernel
{
    class SessionUpdaterSvc : ServicePlugin
    {
        ...
        private static void UpdateGroupList(int i)
        {
            ...
            //            }
            //        CoolQDispatcher.Current.SessionList.AddOrUpdateGroup(v2);
            ...
            //string[] oldGroups = CoolQDispatcher.Current.SessionList.Sessions.Select(k => k.Value.Id).ToArray();
            ...
            //    try
            //    {
            //        CoolQDispatcher.Current.SessionList.RemoveGroup(groupId);
            //    }
            //    catch (Exception)
            //    {
            //        // ignored
