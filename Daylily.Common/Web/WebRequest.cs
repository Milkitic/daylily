...
namespace Daylily.Common.Web
{
    ...
    public static class WebRequest
    {
        ...
        private static string SaveBinaryFile(WebResponse response, string savePath, string ext)
        {
            ...
            var imagePath = Path.Combine(Domain.CacheImagePath);
        ...
        private static HttpWebResponse TryGetResponse(System.Net.WebRequest request)
        {
