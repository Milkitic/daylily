...
namespace Daylily.CoolQ.Message
{
    ...
    public abstract class CoolQCode
    {
        ...
        /// <summary>
        /// CoolQ所在的目录，若CQ与本程序在同一平台，此属性有效，可节省网络请求。
        /// </summary>
        ...
        {
            source = AntiEscape(DecodeAtToText(DecodeBFaceToText(DecodeFaceToText(DecodeImageToText(source)))));
            // TODO
            return source;
        }
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        private static string DecodeFaceToText(string source)
        {
            StringBuilder sb = new StringBuilder(source);
            StringFinder sf = new StringFinder(source);
